...
1. 创建 Supabase 免费项目。
2. 在 SQL Editor 执行 `supabase/migrations/202607190001_initial_schema.sql`。
...
- 数据库迁移：[supabase/migrations/202607190001_initial_schema.sql](supabase/migrations/202607190001_initial_schema.sql)
